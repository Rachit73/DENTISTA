...
const Section = ({ id, title, children, className = "" }: { id?: string, title?: string, children: React.ReactNode, className?: string }) => (
  ...
  >
    {title && <h2 className="text-3xl md:text-5xl font-extrabold text-urbandent-dark mb-8 md:mb-16 text-center tracking-tight">{title}</h2>}
    {children}
  </motion.section>
);
...
const TreatmentCard = ({ title, desc, img, icon: Icon }: { title: string, desc: string, img: string, icon: React.ElementType }) => (
  ...
  >
    <div className="absolute top-6 right-6 bg-pink-50 p-3 rounded-full text-urbandent-pink group-hover:bg-urbandent-pink group-hover:text-white transition-colors duration-300">
      <Icon size={24} />
    </div>
    ...
    <h3 className="text-2xl font-bold text-urbandent-dark mb-3">{title}</h3>
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md z-40 border-b border-gray-100 shadow-sm" aria-label="Main Navigation">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 md:py-4 flex justify-between items-center">
          <div className="flex items-center gap-2 md:gap-3">
            <div className="w-10 h-10 md:w-14 md:h-14 rounded-full overflow-hidden border-2 border-urbandent-pink shadow-sm bg-white flex-shrink-0 flex items-center justify-center">
              <img src="/logo.svg" alt="URBANDENT Logo" className="w-full h-full p-1" onError={(e) => { e.currentTarget.src = 'https://ui-avatars.com/api/?name=UD&background=F2277E&color=fff&rounded=true' }} />
            </div>
            <span className="text-2xl md:text-3xl font-extrabold text-urbandent-teal tracking-tighter uppercase">URBANDENT</span>
          </div>
          <div className="hidden md:flex gap-8 font-medium text-gray-700">
            <a href="#home" className="hover:text-urbandent-pink transition-colors">Home</a>
            <a href="#treatments" className="hover:text-urbandent-pink transition-colors">Treatments</a>
            <a href="#about" className="hover:text-urbandent-pink transition-colors">About</a>
            <a href="#contact" className="hover:text-urbandent-pink transition-colors">Contact</a>
          </div>
          <a href="#book" className="bg-urbandent-pink text-white px-4 py-2 md:px-6 md:py-2.5 rounded-full text-sm md:text-base font-semibold hover:bg-pink-600 transition-colors shadow-md hover:shadow-lg whitespace-nowrap">
            Book Now
          </a>
        </div>
      </nav>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="text-left space-y-4 md:space-y-8">
            <motion.div
              ...
              className="inline-flex items-center gap-2 bg-teal-50 text-urbandent-teal px-3 py-1 rounded-full text-xs md:text-sm font-semibold tracking-wide border border-teal-100"
            >
              <Crown size={14} className="text-urbandent-pink" />
              Premium Dental Care
            </motion.div>
            <motion.h1 
              initial={{ opacity: 0, y: 20 }}
              ...
              className="text-5xl sm:text-6xl md:text-7xl font-extrabold text-urbandent-dark leading-tight tracking-tighter"
            >
              A confident smile begins with <span className="text-transparent bg-clip-text bg-gradient-to-r from-urbandent-pink to-pink-400">healthy teeth.</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <a href="#book" className="inline-block bg-urbandent-pink text-white px-8 py-4 md:px-10 md:py-5 rounded-full text-lg md:text-xl font-bold shadow-xl hover:bg-pink-600 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
                Book Appointment
              </a>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-urbandent-teal/20 to-transparent mix-blend-multiply"></div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto space-y-12 md:space-y-24">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-urbandent-dark/80 to-transparent p-8">
            ...
            >
              <h3 className="text-4xl font-bold text-urbandent-teal">Dr. Deval Naik</h3>
              ...
              <div className="pt-6 flex gap-8">
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex-1 text-center">
                  <p className="text-4xl font-extrabold text-urbandent-pink">18+</p>
                  <p className="text-gray-500 font-medium mt-1">Years Exp.</p>
                </div>
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex-1 text-center">
                  <p className="text-4xl font-extrabold text-urbandent-pink">2005</p>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-16">
            ...
            <motion.div 
              ...
              className="flex-1 space-y-6"
            >
              <h3 className="text-4xl font-bold text-urbandent-teal">Dr. Tejal Shah</h3>
              <p className="text-xl text-gray-700 leading-relaxed">
                Dr. Tejal Shah is a co-founder & Dental Surgeon at URBANDENT. She obtained her Bachelor of Dental Surgery from Maharashtra University of Health Science (Nashik) in 2005.
              </p>
              <p className="text-xl text-gray-700 leading-relaxed">
      ...
      <Section id="book" title="Book Your Consultation" className="bg-urbandent-teal text-white relative overflow-hidden">
          ...
          <AnimatePresence mode="wait">
            {!isSubmitted ? (
              <motion.form 
                ...
                className="space-y-6 bg-white p-10 rounded-3xl shadow-2xl text-gray-800 border-t-8 border-urbandent-pink"
              >
                <div>
                  <label className="block text-sm font-semibold text-gray-600 mb-2">Full Name</label>
                  <input required type="text" placeholder="John Doe" className="w-full p-4 rounded-2xl bg-gray-50 border border-gray-200 focus:ring-2 focus:ring-urbandent-pink focus:border-transparent outline-none transition-all" />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-600 mb-2">Phone Number</label>
                  <input required type="tel" placeholder="+91 98765 43210" className="w-full p-4 rounded-2xl bg-gray-50 border border-gray-200 focus:ring-2 focus:ring-urbandent-pink focus:border-transparent outline-none transition-all" />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-600 mb-2">Preferred Date</label>
                  <input required type="date" className="w-full p-4 rounded-2xl bg-gray-50 border border-gray-200 focus:ring-2 focus:ring-urbandent-pink focus:border-transparent outline-none transition-all" />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-600 mb-2">Preferred Time</label>
                  <input required type="time" className="w-full p-4 rounded-2xl bg-gray-50 border border-gray-200 focus:ring-2 focus:ring-urbandent-pink focus:border-transparent outline-none transition-all" />
                </div>
                <button type="submit" className="w-full bg-urbandent-pink text-white py-5 rounded-2xl text-xl font-bold hover:bg-pink-600 hover:shadow-lg transition-all transform active:scale-95">
                  Confirm Appointment
                </button>
              </motion.form>
            ) : (
              <motion.div 
                ...
                className="bg-white p-16 rounded-3xl shadow-2xl text-center flex flex-col items-center justify-center space-y-6 border-t-8 border-urbandent-teal"
                role="status"
                aria-live="polite"
              >
                <motion.div
                ...
                >
                  <CheckCircle2 className="text-urbandent-teal w-24 h-24" aria-hidden="true" />
                </motion.div>
                <h3 className="text-3xl font-bold text-urbandent-dark">Booking Confirmed!</h3>
      ...
      <Section id="contact" title="Visit Us" className="bg-white">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 mb-8 md:mb-12">
          <div className="flex flex-row md:flex-col items-center text-left md:text-center p-4 md:p-8 bg-pink-50/50 rounded-2xl border border-pink-100 gap-4">
            <div className="bg-white p-3 rounded-full text-urbandent-pink shadow-sm flex-shrink-0"><MapPin className="w-6 h-6" /></div>
            <div>
              <h4 className="text-base md:text-xl font-bold text-urbandent-dark mb-1">Location</h4>
          ...
          <div className="flex flex-row md:flex-col items-center text-left md:text-center p-4 md:p-8 bg-teal-50/50 rounded-2xl border border-teal-100 gap-4">
            <div className="bg-white p-3 rounded-full text-urbandent-teal shadow-sm flex-shrink-0"><Phone className="w-6 h-6" /></div>
            <div>
              <h4 className="text-base md:text-xl font-bold text-urbandent-dark mb-1">Phone</h4>
              <p className="text-xs md:text-base text-gray-600">+91 98765 43210<br/>Mon-Sat, 9am - 6pm</p>
            </div>
          </div>
          <div className="flex flex-row md:flex-col items-center text-left md:text-center p-4 md:p-8 bg-pink-50/50 rounded-2xl border border-pink-100 gap-4">
            <div className="bg-white p-3 rounded-full text-urbandent-pink shadow-sm flex-shrink-0"><Mail className="w-6 h-6" /></div>
            <div>
              <h4 className="text-base md:text-xl font-bold text-urbandent-dark mb-1">Email</h4>
              <p className="text-xs md:text-base text-gray-600">contact@urbandent.in<br/>support@urbandent.in</p>
            </div>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="bg-urbandent-dark text-gray-400 py-12 text-center border-t-4 border-urbandent-pink">
        <div className="flex justify-center items-center gap-3 mb-6">
          <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-urbandent-pink shadow-sm bg-white flex-shrink-0 flex items-center justify-center">
            <img src="/logo.svg" alt="URBANDENT Logo" className="w-full h-full p-1.5" onError={(e) => { e.currentTarget.src = 'https://ui-avatars.com/api/?name=UD&background=F2277E&color=fff&rounded=true' }} />
          </div>
          <span className="text-3xl font-extrabold text-white tracking-tighter uppercase">URBANDENT</span>
        </div>
        <p>&copy; {new Date().getFullYear()} URBANDENT Clinic. All rights reserved.</p>
      </footer>
